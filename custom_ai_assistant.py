...
def _handle_cv_formatting(cv_files: List[Dict]) -> Dict[str, Any]:
    ...
    try:
        ...
        # Format the CV using the ENHANCED V24 Mawney Partners template with viewport fixed
        try:
            from enhanced_cv_formatter_v24 import enhanced_cv_formatter_v24
            formatted_result = enhanced_cv_formatter_v24.format_cv_with_template(cv_content, filename)
        except ImportError:
            try:
                # Fallback to V23 enhanced formatter
