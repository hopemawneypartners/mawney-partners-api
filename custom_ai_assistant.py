...
def _handle_cv_formatting(cv_files: List[Dict]) -> Dict[str, Any]:
    ...
    try:
        ...
        # Format the CV using the ENHANCED V23 Mawney Partners template with minimal page breaks
        try:
            from enhanced_cv_formatter_v23 import enhanced_cv_formatter_v23
            formatted_result = enhanced_cv_formatter_v23.format_cv_with_template(cv_content, filename)
        except ImportError:
            try:
                # Fallback to V22 enhanced formatter
